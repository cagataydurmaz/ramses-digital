...
const localPages = [
  ...
  { href: '/gaziantep-dijital-pazarlama', label: 'Gaziantep Dijital Pazarlama' },
  { href: '/gaziantep-reklam-ajansi', label: 'Gaziantep Reklam Ajansı' },
  { href: '/gaziantep-seo', label: 'Gaziantep SEO' },
  { href: '/gaziantep-web-tasarim', label: 'Gaziantep Web Tasarım' },
  { href: '/gaziantep-google-ads', label: 'Gaziantep Google Ads' },
  { href: '/gaziantep-yazilim-ajansi', label: 'Gaziantep Yazılım Ajansı' },
  { href: '/konya-dijital-pazarlama', label: 'Konya Dijital Pazarlama' },
  { href: '/konya-reklam-ajansi', label: 'Konya Reklam Ajansı' },
  { href: '/konya-seo', label: 'Konya SEO' },
  { href: '/konya-web-tasarim', label: 'Konya Web Tasarım' },
  { href: '/konya-google-ads', label: 'Konya Google Ads' },
  { href: '/konya-yazilim-ajansi', label: 'Konya Yazılım Ajansı' },
  { href: '/mersin-dijital-pazarlama', label: 'Mersin Dijital Pazarlama' },
  { href: '/mersin-reklam-ajansi', label: 'Mersin Reklam Ajansı' },
  { href: '/mersin-seo', label: 'Mersin SEO' },
  { href: '/mersin-web-tasarim', label: 'Mersin Web Tasarım' },
  { href: '/mersin-google-ads', label: 'Mersin Google Ads' },
  { href: '/mersin-yazilim-ajansi', label: 'Mersin Yazılım Ajansı' },
  { href: '/kayseri-dijital-pazarlama', label: 'Kayseri Dijital Pazarlama' },
  { href: '/kayseri-reklam-ajansi', label: 'Kayseri Reklam Ajansı' },
  { href: '/kayseri-seo', label: 'Kayseri SEO' },
  { href: '/kayseri-web-tasarim', label: 'Kayseri Web Tasarım' },
  { href: '/kayseri-google-ads', label: 'Kayseri Google Ads' },
  { href: '/kayseri-yazilim-ajansi', label: 'Kayseri Yazılım Ajansı' },
  { href: '/eskisehir-dijital-pazarlama', label: 'Eskişehir Dijital Pazarlama' },
  { href: '/eskisehir-reklam-ajansi', label: 'Eskişehir Reklam Ajansı' },
  { href: '/eskisehir-seo', label: 'Eskişehir SEO' },
  { href: '/eskisehir-web-tasarim', label: 'Eskişehir Web Tasarım' },
  { href: '/eskisehir-google-ads', label: 'Eskişehir Google Ads' },
  { href: '/eskisehir-yazilim-ajansi', label: 'Eskişehir Yazılım Ajansı' },
]
