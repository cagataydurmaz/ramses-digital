...
const faqs = [
  ...
  { q: 'SEO paketleriniz ne kadar?', a: 'Sektör, rekabet düzeyi ve hedef şehir sayısına göre kapsam ve fiyat değişir. Ücretsiz danışmanlıkta işletmenize özel teklif sunuyoruz.' },
