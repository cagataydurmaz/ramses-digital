...
export const metadata: Metadata = {
  title: 'Konya Dijital Pazarlama Ajansı | 100+ Proje — Ramses Dijital',
  description:
    'Konya\'nın dijital pazarlama ajansı — 100+ proje deneyimi. SEO, Google Ads, web tasarım ve otomasyon ile tarım makineleri, gıda ve turizm sektörünü büyütün. Ücretsiz danışmanlık alın.',
  alternates: { canonical: 'https://ramsesdigital.com/konya-dijital-pazarlama' },
  openGraph: {
    title: 'Konya Dijital Pazarlama Ajansı | Ramses Dijital',
    description: 'Konya işletmeleri için ölçülebilir dijital pazarlama. SEO, Google Ads, web ve otomasyon.',
    url: 'https://ramsesdigital.com/konya-dijital-pazarlama',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Konya Dijital Pazarlama — Ramses Dijital',
    description: 'Konya\'da SEO, Google Ads, web tasarım ve pazarlama otomasyonu.',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
}
...
const channels = [
  {
    ...
    desc: 'Konya\'daki müşterileriniz Google\'da sizi bulsun. Yerel SEO, teknik SEO, GEO ve AEO stratejileriyle organik büyüme.',
  ...
  },
  {
    ...
    desc: 'Konya\'nın rekabetçi sektörlerinde doğru kitleye hedefli reklam. Bütçenizi boşa harcamadan dönüşüm.',
    tags: ['Google Ads', 'Search', 'Display', 'Retargeting'],
    href: '/konya-google-ads',
  },
  {
    icon: Globe,
    title: 'Web Tasarım & Geliştirme',
    desc: 'Hızlı, mobil uyumlu, dönüşüm odaklı web siteleri. Tarım makineleri üreticilerine özel katalog, turizm işletmelerine özel rezervasyon altyapısı da dahil.',
  ...
  },
  {
    ...
    desc: 'Listenizi satışa dönüştüren hoşgeldin serisi, kampanya ve drip akışları. B2B bayi ilişkilerinde de etkili.',
...
const advantages = [
  { icon: MapPin, title: 'Uzaktan Çalışma Modeli', desc: 'Kocaeli merkezli olsak da tüm süreç uzaktan yürütülüyor — Konya\'nın trafiğinde toplantıya gitmenize gerek yok.' },
  ...
  { icon: Clock, title: 'Sektöre Özel Hızlı Başlangıç', desc: 'Anlaşma sonrası 5 iş günü içinde ilk çalışmalar başlar. Konya\'nın tarım makineleri, gıda ve turizm sektörlerine hakim strateji kurgusu.' },
]

const sectors = [
  'Tarım Makineleri Üreticileri', 'Gıda & Tahıl Sanayii', 'Otomotiv Yan Sanayi', 'Dini Turizm (Otel, Tur Operatörü)',
  'Hukuk Bürosu', 'Diş Hekimi & Diş Kliniği', 'Eğitim Kurumları', 'Toptan Ticaret',
]

const faqs = [
  { q: 'Konya\'da dijital pazarlamaya ne zaman başlamalıyım?', a: 'SEO otorite kazanmak zaman aldığı için erken başlamak avantaj sağlar; Konya\'daki rakiplerinizin bir kısmı zaten dijitale yatırım yapıyor. Küçük bir bütçeyle Google Ads ile kısa vadede trafik almak, SEO ile de uzun vadeli bir varlık inşa etmek mümkün.' },
  { q: 'Konya\'daki hangi dijital kanal en hızlı sonuç verir?', a: 'Hızlı sonuç için Google Ads: 1-2 hafta içinde potansiyel müşteriler arar ve reklamınızı görür. Uzun vadeli ve düşük maliyetli büyüme için SEO: 3-6 ayda organik trafik birikmeye başlar. İkisini birlikte yürütmek en akıllıca stratejidir.' },
  { q: 'Tarım makineleri üreticisi olarak dijital pazarlamadan nasıl fayda görürüm?', a: 'B2B alıcılar arama motorunda bayi/tedarikçi araştırması yapıyor — "tarım makinesi üretici Konya" gibi aramalar. SEO ve LinkedIn/Google Ads kombinasyonuyla bu talebi yakalamak mümkün. Dini turizm işletmeleri için ise ziyaretçi odaklı görsel içerik ve rezervasyon dönüşümü ayrı bir strateji gerektiriyor.' },
  { q: 'Konya\'da dijital pazarlama için aylık ne kadar bütçe ayırmalıyım?', a: 'Hedeflediğiniz kanal kombinasyonuna (SEO, Google Ads, web tasarım) ve sektörünüze göre değişir. Ücretsiz danışmanlıkta işletmenize özel bir bütçe planı netleştirebiliriz.' },
  ...
  { q: 'Konya\'daki hukuk büroları, klinikler ve turizm işletmeleri için özel bir yaklaşımınız var mı?', a: 'Evet. Hukuk büroları için Avukatlık Kanunu\'nun reklam yasağı nedeniyle SEO ve içerik otoritesine dayalı strateji uyguluyoruz. Turizm işletmeleri için ise görsel ağırlıklı içerik ve yerel/uluslararası SEO kombinasyonu kuruyoruz.' },
  { q: 'Uzaktan çalışıyor musunuz, yoksa Konya\'da yerinde mi?', a: 'Tüm hizmetlerimiz uzaktan yürütülüyor. Merkezimiz Kocaeli\'de, fiziksel ofisimiz Konya\'da yok. Toplantılar Google Meet/Zoom üzerinden, raporlar dijital dashboard ve PDF ile paylaşılıyor.' },
  { q: 'Yapay zeka reklamcılığı ve GEO nedir, Konya işletmesi için gerekli mi?', a: 'GEO (Generative Engine Optimization), ChatGPT veya Gemini\'de "Konya\'da [sektörünüz]" aramasında önerilmek için yapılan optimizasyondur. Bu henüz doymamış bir kanal — erken hareket eden işletmeler önemli bir avantaj kazanıyor.' },
]
  ...
  '@graph': [
    {
      ...
      name: 'Ramses Dijital',
      description: 'Konya dahil Türkiye genelinde hizmet veren dijital pazarlama ajansı. SEO, Google Ads, web tasarım ve otomasyon.',
      ...
      areaServed: [
        ...
        { '@type': 'City', name: 'Ereğli' },
        { '@type': 'City', name: 'Akşehir' },
      ],
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Konya Dijital Pazarlama', item: 'https://ramsesdigital.com/konya-dijital-pazarlama' },
      ],
    },
    {
      '@type': 'FAQPage',
...
export default function KonyaDijitalPazarlamaPage() {
  return (
    <>
      <script
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-blue-400 text-sm font-medium">Konya&apos;ya Uzaktan Hizmet</span>
          </div>
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto mb-4 leading-relaxed">
            Konya&apos;nın tarım makineleri üreticilerine, gıda sanayine ve dini turizm işletmelerine özel SEO, Google Ads, web tasarım ve otomasyon.
          </p>
          <p className="text-zinc-500 text-sm mb-10">
            Selçuklu · Meram · Karatay · Ereğli · Akşehir · Beyşehir · Çumra
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Konya İşletmenizi Büyütecek Kanallar
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto">
              Üretim ve turizm ağırlıklı Konya pazarında satış döngüsü farklı segmentlerde farklı ilerliyor — doğru kanal kombinasyonu bu süreci hızlandırır.
            </p>
          </div>
      ...
      <section className="py-16 px-6 bg-[#080D18]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-white mb-3">Konya&apos;da Hizmet Verdiğimiz Sektörler</h2>
          <p className="text-zinc-500 text-sm mb-8">Tarım makineleri üretiminin ve dini turizmin operasyonel diliyle konuşuyoruz, jenerik pazarlama kalıplarıyla değil.</p>
      ...
      <RelatedPages
        pages={[
          { label: 'Konya SEO', href: '/konya-seo' },
      ...
      <section className="py-20 px-6 bg-[#080D18]">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Konya&apos;da Dijital Büyümeye Başlayın
          </h2>
