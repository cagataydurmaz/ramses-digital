...
export const metadata: Metadata = {
  title: 'Ankara Dijital Pazarlama Ajansı | 100+ Proje — Ramses Dijital',
  description:
    'Ankara\'nın dijital pazarlama ajansı — 100+ proje deneyimi. SEO, Google Ads, web tasarım ve otomasyon ile başkentteki işletmenizi büyütün. Ücretsiz danışmanlık alın.',
  alternates: { canonical: 'https://ramsesdigital.com/ankara-dijital-pazarlama' },
  openGraph: {
    title: 'Ankara Dijital Pazarlama Ajansı | Ramses Dijital',
    description: 'Ankara işletmeleri için ölçülebilir dijital pazarlama. SEO, Google Ads, web ve otomasyon.',
    url: 'https://ramsesdigital.com/ankara-dijital-pazarlama',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Ankara Dijital Pazarlama — Ramses Dijital',
    description: 'Ankara\'da SEO, Google Ads, web tasarım ve pazarlama otomasyonu.',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
}
...
const channels = [
  {
    ...
    desc: 'Ankara\'daki müşterileriniz Google\'da sizi bulsun. Yerel SEO, teknik SEO, GEO ve AEO stratejileriyle organik büyüme.',
  ...
  },
  {
    ...
    desc: 'Ankara\'daki potansiyel müşterilere hedefli reklam. Bütçenizi boşa harcamadan dönüşüm.',
    tags: ['Google Ads', 'Search', 'Display', 'Retargeting'],
    href: '/ankara-google-ads',
  },
  {
    icon: Globe,
    title: 'Web Tasarım & Geliştirme',
    desc: 'Hızlı, mobil uyumlu, dönüşüm odaklı web siteleri. Next.js ile kurumsal performans.',
...
const advantages = [
  { icon: MapPin, title: 'Uzaktan Çalışma Modeli', desc: 'Kocaeli merkezli olsak da tüm süreç uzaktan yürütülüyor — Ankara toplantıları için trafiğe çıkmanıza gerek yok.' },
...
const sectors = [
  'Hukuk Bürosu', 'Danışmanlık', 'Eğitim & Kurs', 'Sağlık & Klinik',
  'B2B Tedarikçiler', 'Kamu İhale Danışmanlığı', 'İnşaat & Gayrimenkul', 'Güzellik & Estetik',
]

const faqs = [
  { q: 'Ankara\'da dijital pazarlamaya ne zaman başlamalıyım?', a: 'En iyi zaman şimdi. Ankara\'daki kurumsal ve profesyonel hizmet sektöründe dijital varlık artık beklenen bir standart — geciktirmek arama motoru otoritesinde geri kalmak anlamına gelir.' },
  { q: 'Ankara\'da hangi dijital kanal en hızlı sonuç verir?', a: 'Hızlı sonuç için Google Ads: 1-2 hafta içinde potansiyel müşteriler arar ve reklamınızı görür. Uzun vadeli ve düşük maliyetli büyüme için SEO: 3-6 ayda organik trafik birikmeye başlar. İkisini birlikte yürütmek en akıllıca stratejidir.' },
  { q: 'Ankara\'daki rakiplerime karşı nasıl öne çıkabilirim?', a: 'Üç odak noktası: (1) Google Haritalar\'da üst sıra. (2) Yerel/sektörel anahtar kelimede içerik üstünlüğü. (3) Kurumsal güven sinyalleri — Ankara\'nın B2B ağırlıklı pazarında referanslar ve otorite içeriği belirleyici.' },
  { q: 'Ankara\'da dijital pazarlama için aylık ne kadar bütçe ayırmalıyım?', a: 'Hedeflediğiniz kanal kombinasyonuna (SEO, Google Ads, web tasarım) ve rekabet düzeyine göre değişir. Ücretsiz danışmanlıkta işletmenize özel bir bütçe planı çıkarıyoruz.' },
  ...
  { q: 'Ankara\'daki hukuk büroları ve danışmanlık firmaları için özel bir yaklaşımınız var mı?', a: 'Evet. Portföyümüzde İstanbul Barosu\'na kayıtlı avukat müşterilerimiz var. Avukatlık Kanunu\'nun reklam yasağı nedeniyle bu sektörde tamamen SEO ve içerik otoritesine dayalı, kurumsal kimliğe uygun bir strateji uyguluyoruz — Ankara\'daki benzer sektörler için de aynı yaklaşım geçerli.' },
  { q: 'Uzaktan çalışıyor musunuz, yoksa Ankara\'da yerinde mi?', a: 'Tüm hizmetlerimiz uzaktan yürütülüyor. Toplantılar Google Meet/Zoom üzerinden, raporlar dijital dashboard ve PDF ile paylaşılıyor.' },
  { q: 'Yapay zeka reklamcılığı ve GEO nedir, Ankara işletmesi için gerekli mi?', a: 'GEO (Generative Engine Optimization), ChatGPT veya Gemini\'de "Ankara\'da [sektörünüz]" aramasında önerilmek için yapılan optimizasyondur. Ankara\'nın kurumsal/B2B pazarında bu kanal henüz doymamış — erken hareket eden işletmeler avantajlı.' },
]
  ...
  '@graph': [
    {
      ...
      name: 'Ramses Dijital',
      description: 'Ankara dahil Türkiye genelinde hizmet veren dijital pazarlama ajansı. SEO, Google Ads, web tasarım ve otomasyon.',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Ankara Dijital Pazarlama', item: 'https://ramsesdigital.com/ankara-dijital-pazarlama' },
      ],
    },
    {
      '@type': 'FAQPage',
...
export default function AnkaraDijitalPazarlamaPage() {
  return (
    <>
      <script
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-blue-400 text-sm font-medium">Ankara&apos;ya Uzaktan Hizmet</span>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-blue-500/5 border border-blue-500/15 rounded-2xl p-8 text-center">
            ...
            <p className="text-zinc-400 mb-6 max-w-xl mx-auto text-sm leading-relaxed">
              İstanbul Barosu&apos;na kayıtlı avukatlar için tamamen uzaktan yürüttüğümüz web tasarım ve SEO çalışmaları hâlâ canlı ve aktif.
              Fiziksel varlık olmadan da gerçek sonuç aldığımızın kanıtı — Ankara işletmeleri için de aynı süreç geçerli.
            </p>
      ...
      <section className="py-20 px-6 bg-[#080D18]">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Ankara&apos;da Dijital Büyümeye Başlayın
          </h2>
