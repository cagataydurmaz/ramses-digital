...
export const metadata: Metadata = {
  ...
  description:
    'Ankara\'nın dijital pazarlama ajansı. SEO, Google Ads, web tasarım, e-posta ve otomasyon hizmetleriyle işletmenizi büyütün. Kocaeli merkezli, Ankara dahil Türkiye geneli uzaktan hizmet.',
...
const faqs = [
  ...
  { q: 'Ankara\'da dijital pazarlama için aylık ne kadar bütçe ayırmalıyım?', a: 'Başlangıç için Google Ads + yönetim + temel SEO kombinasyonu aylık 8.000-18.000 TL aralığında. Sadece SEO 8.000-20.000 TL, sadece Google Ads 3.000+ TL reklam bütçesi + yönetim ücreti.' },
