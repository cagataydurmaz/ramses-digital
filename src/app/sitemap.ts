...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const statics = [
    ...
    { path: '/sehirler',   priority: 0.9, freq: 'monthly' },
    { path: '/hizmetler/seo',         priority: 0.95, freq: 'monthly' },
    { path: '/hizmetler/google-ads',  priority: 0.95, freq: 'monthly' },
    { path: '/hizmetler/n8n-otomasyon',        priority: 0.9,  freq: 'monthly' },
    { path: '/hizmetler/web-tasarim', priority: 0.9,  freq: 'monthly' },
