...
export const metadata: Metadata = {
  title: 'Kayseri Reklam Ajansı | 100+ Proje — Ramses Dijital',
  description:
    'Kayseri\'nin dijital reklam ajansı — mobilya, gıda ve tekstil sektörüne özel strateji. Google Ads, SEO ve pazarlama otomasyonu. Ücretsiz teklif alın.',
  alternates: { canonical: 'https://ramsesdigital.com/kayseri-reklam-ajansi' },
  openGraph: {
    title: 'Kayseri Reklam Ajansı | Ramses Dijital',
    description: 'Kayseri\'de işletmenizi büyüten dijital reklam ajansı. Google Ads, SEO, web tasarım ve otomasyon.',
    url: 'https://ramsesdigital.com/kayseri-reklam-ajansi',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Kayseri Reklam Ajansı — Ramses Dijital',
    description: 'Kayseri işletmeleri için dijital pazarlama, Google Ads, SEO.',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
}

const services = [
  { icon: Search, title: 'SEO & Yerel SEO', desc: 'Google\'da "Kayseri + sektörünüz" aramalarında üst sıralarda çıkın. Google Business Profile yönetimi dahil.', href: '/kayseri-seo' },
  { icon: Megaphone, title: 'Google Ads', desc: 'Kayseri\'de potansiyel müşterilere tam doğru anda ulaşın. Reklam bütçenizi boşa harcamayın.', href: '/kayseri-google-ads' },
  { icon: Globe, title: 'Web Tasarım', desc: 'Dönüşüm odaklı, hızlı yüklenen web siteleri. Mobil uyumlu, SEO hazır.', href: '/kayseri-web-tasarim' },
  ...
  { icon: Mail, title: 'E-posta Pazarlama', desc: 'Listenizi müşteriye dönüştüren e-posta serileri. B2B toptan ilişkilerinde de etkili.', href: '/hizmetler/eposta-otomasyon' },
...
const whyUs = [
  { icon: MapPin, title: 'Kayseri\'nin Sektörel Kimliğini Biliyoruz', desc: 'Mobilya üretimi, gıda sanayii ve tekstilin dinamiklerini anlayan bir ekiple çalışıyorsunuz. Genel şablon yok.' },
  { icon: Users, title: 'Türkiye Genelinde Kanıtlanmış Referanslar', desc: 'Kayseri\'ye özel vaka çalışmamız henüz yok, ama Türkiye genelinde canlı, ziyaret edilebilir projelerimiz var.' },
...
const faqs = [
  { q: 'Kayseri\'de reklam ajansı seçerken nelere dikkat etmeliyim?', a: 'En önemli kriter gerçek referanslar ve şeffaf raporlamadır. Ajansın sektörünüze (örneğin mobilya üretimi veya gıda) daha önce çalışıp çalışmadığını, somut sonuçlar sunup sunamadığını ve aylık raporlama yapıp yapmadığını sormalısınız. Sözleşme imzalamadan önce canlı müşteri sitelerine mutlaka bakın.' },
  { q: 'Kayseri\'de dijital reklamın maliyeti nedir?', a: 'Google Ads reklam bütçesi, SEO yönetim ücreti ve web sitesi maliyeti işletmenizin büyüklüğüne ve hedeflerinize göre değişir. Ücretsiz danışmanlık seansında size özel bilgi paylaşıyoruz.' },
  { q: 'Kayseri\'deki işletmem için Google\'da nasıl üst sıralara çıkarım?', a: 'İki paralel strateji gerekli: Google Business Profile optimizasyonu (harita paketi için) ve web sitesi SEO\'su (organik arama için). GBP için işletme bilgilerini eksiksiz doldurmak, müşteri yorumları toplamak ve yerel dizinlere kayıt olmak kritiktir. Web sitesi için Kayseri\'ye özel içerik üretmek şarttır.' },
  { q: 'Kayseri\'de hangi sektörlere hizmet veriyorsunuz?', a: 'Kayseri\'nin güçlü sektörleri olan mobilya üretimi, gıda üretimi (pastırma, sucuk) ve tekstilin yanında hukuk, diş hekimliği, güzellik & estetik ve toptan ticaret gibi alanlarda da çalışıyoruz. Sektöre özel strateji kuruyoruz, şablon uygulamıyoruz.' },
  ...
  { q: 'Kayseri\'nin hangi ilçelerine hizmet veriyorsunuz?', a: 'Melikgazi, Kocasinan, Talas, Develi, Yahyalı, İncesu, Hacılar ve Pınarbaşı dahil Kayseri\'nin tüm ilçelerine uzaktan hizmet veriyoruz.' },
  ...
  { q: 'Yapay zeka (ChatGPT, Gemini) aramalarında da görünür olabilir miyim?', a: 'Evet, bu GEO (Generative Engine Optimization) olarak adlandırılıyor. Kayseri\'de sektörünüzü araştıran birinin ChatGPT\'ye sorduğunda sizi önermesi için yapılandırılmış içerik, citation-worthy veriler ve otoriter backlink profili gerekiyor. Tüm SEO paketlerimize GEO stratejisi dahildir.' },
  { q: 'Fiziksel olarak Kayseri\'de ofisiniz var mı?', a: 'Hayır, merkezimiz Kocaeli\'de — Kayseri\'ye tamamen uzaktan hizmet veriyoruz. Keşif görüşmesi, strateji onayı ve raporlama Google Meet/Zoom üzerinden yürütülüyor.' },
  { q: 'Reklam hesabımız kimin adına açılır?', a: 'Firmanızın adına. Google Ads hesabı sizde açılır, biz yönetici olarak erişiriz. B2B toptan ilişkilerinde sıkça sorulan bir güven meselesi — hesap üzerinde tam kontrol her zaman sizde kalır.' },
]
  ...
  '@graph': [
    {
      ...
      name: 'Ramses Dijital',
      description: 'Kayseri\'nin dijital reklam ve pazarlama ajansı — uzaktan hizmet',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Kayseri Reklam Ajansı', item: 'https://ramsesdigital.com/kayseri-reklam-ajansi' },
      ],
    },
    {
      '@type': 'FAQPage',
...
export default function KayseriReklamAjansiPage() {
  return (
    <>
      <script
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto mb-4 leading-relaxed">
            Google Ads, SEO, web tasarım ve pazarlama otomasyonu ile Kayseri işletmelerini dijitalde büyütüyoruz. Mobilya üretimi, gıda sanayii ve tekstile özel strateji.
          </p>
          <p className="text-zinc-500 text-sm mb-10">
            Melikgazi · Kocasinan · Talas · Develi · Yahyalı · İncesu · Hacılar · Pınarbaşı
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Kayseri İşletmeniz İçin Tüm Dijital Hizmetler
            </h2>
      ...
      <section className="py-20 px-6 bg-[#080D18]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Neden Kayseri&apos;deki İşletmeler Bizi Seçiyor?
            </h2>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-blue-500/5 border border-blue-500/15 rounded-2xl p-8 text-center">
            ...
            <p className="text-zinc-400 mb-6 max-w-xl mx-auto text-sm leading-relaxed">
              Kayseri&apos;ye özel bir vaka çalışmamız henüz yok — bunu saklamıyoruz. Ancak Türkiye genelinde
              ziyaret edilebilir, canlı SEO ve web tasarım projelerimiz var. Portföyümüzü inceleyip aynı
              mühendislik disipliniyle Kayseri işletmeniz için nasıl çalışacağımızı görebilirsiniz.
            </p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Kayseri&apos;de Dijitalde Öne Çıkmaya Hazır mısınız?
          </h2>
