...
export const metadata: Metadata = {
  title: 'Eskişehir Yazılım Ajansı — Ramses Dijital',
  description:
    'Eskişehir\'de yazılım ajansı. Web uygulaması, otomasyon, API entegrasyonu ve dijital pazarlama yazılımları. Öğrenciye hitap eden işletmeler, sanayi firmaları ve KOBİ\'ler için özel yazılım çözümleri.',
  alternates: { canonical: 'https://ramsesdigital.com/eskisehir-yazilim-ajansi' },
  openGraph: {
    title: 'Eskişehir Yazılım Ajansı | Ramses Dijital',
    description: 'Eskişehir işletmeleri için özel yazılım, web uygulaması ve otomasyon çözümleri.',
    url: 'https://ramsesdigital.com/eskisehir-yazilim-ajansi',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
}

const solutions = [
  { icon: Globe, title: 'Web Uygulaması & Site', desc: 'Next.js ile yüksek performanslı web siteleri ve uygulamalar. Rezervasyon sisteminden öğrenci portalına kadar.' },
  { icon: Zap, title: 'İş Süreçleri Otomasyonu', desc: 'n8n ile tekrarlayan operasyonları otomatikleştirin. Randevu takibi, CRM, e-posta, bildirim ve fatura akışları.' },
  ...
  { icon: BarChart3, title: 'Veri & Analitik', desc: 'GA4, Looker Studio ve özel dashboard\'lar. Ziyaretçi, satış ve pazarlama verinizi görsel ve anlaşılır hale getirin.' },
...
const faqs = [
  { q: 'Eskişehir\'de yazılım ajansı ile çalışmanın avantajı ne?', a: 'Uzaktan çalışıyoruz, dolayısıyla coğrafi mesafe kısıtımız yok. Ancak Eskişehir\'in öğrenci pazarına ve demiryolu/havacılık yan sanayi sektörüne özgü operasyonel ihtiyaçları — rezervasyon sistemleri, randevu yönetimi, B2B tedarik süreçleri — bilmek büyük fark yaratıyor. Bu sektörlere özel çözüm önerileri sunuyoruz.' },
  { q: 'Özel yazılım mı, hazır SaaS mi kullanmalıyım?', a: 'Çoğu durumda ikisinin kombinasyonu en akıllıcasıdır. Muhasebe, CRM, e-posta gibi alanlarda Parasut, HubSpot, Mailchimp gibi SaaS araçları uygun maliyetli. Rezervasyon sistemi, randevu yönetimi, özel raporlama gibi Eskişehir\'in öğrenci pazarına ve sanayiye özgü süreçler için özel yazılım veya otomasyon daha verimli.' },
  { q: 'Projeyi teslim ettikten sonra destek veriyor musunuz?', a: 'Evet. Teslim sonrası 1-3 ay hata düzeltme garantisi kapsamda. Sanayi firmalarının ERP/tedarik zinciri entegrasyonları canlı sistem olduğu için, aylık bakım paketiyle güncelleme, küçük geliştirme ve teknik izlemeyi sürekli tutuyoruz.' },
  ...
  { q: 'Mevcut yazılımımla entegrasyon yapabilir misiniz?', a: 'Büyük ihtimalle evet. Mikro Yazılım, Logo, SAP, WooCommerce, Shopify, Trendyol, Hepsiburada entegrasyonlarında deneyimimiz var. Eskişehir\'in sanayi firmalarının kullandığı ERP sistemleriyle de API veya webhook bazlı entegrasyon kurabiliriz.' },
  { q: 'Yazılım projesine nasıl başlanıyor?', a: 'Önce 30 dakikalık ücretsiz bir görüşmeyle mevcut iş akışınızı ve hangi sistemle (ERP, rezervasyon, randevu vb.) entegre çalışacağımızı netleştiriyoruz. Ardından teknik şartname ve tahmini süreyi paylaşıyor, onayınızla geliştirmeye başlıyoruz. Taahhüt gerektirmez.' },
  { q: 'Fiziksel olarak Eskişehir\'de ofisiniz var mı?', a: 'Hayır, merkezimiz Kocaeli\'de — Eskişehir\'e tamamen uzaktan hizmet veriyoruz. Keşif görüşmesi ve teknik şartname süreci Google Meet/Zoom üzerinden yürütülüyor.' },
...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'Service',
      name: 'Eskişehir Yazılım Ajansı Hizmetleri',
      description: 'Eskişehir işletmeleri için web uygulaması, otomasyon, API entegrasyonu ve yapay zeka çözümleri.',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Eskişehir Yazılım Ajansı', item: 'https://ramsesdigital.com/eskisehir-yazilim-ajansi' },
      ],
    },
    {
      '@type': 'FAQPage',
...
export default function EskisehirYazilimAjansiPage() {
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
            Eskişehir Yazılım Ajansı
            <br />
            <span className="gradient-text">Web, Otomasyon & AI</span>
          </h1>
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            Eskişehir işletmeleri için web uygulaması, iş süreçleri otomasyonu, API entegrasyonu ve yapay zeka çözümleri. Öğrenci pazarının ve sanayinin operasyonel ihtiyaçlarını biliyoruz.
          </p>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl px-6 py-4 text-center">
            <p className="text-zinc-400 text-sm leading-relaxed">
              Ramses Dijital, reklam ajansı kimliğiyle başladı; bugün SEO ve Google Ads&apos;in yanında yazılım geliştirmeyi de aynı disiplinle sunuyor. Eskişehir&apos;de öğrenciye hitap eden işletmeler ve sanayi firmalarıyla çalışırken rezervasyon ve süreç yönetiminin dijitalleşme ihtiyacını doğrudan gördük.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Eskişehir İçin Yazılım Çözümleri
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto">
              Rezervasyon sistemleri ve sanayi üretim süreçlerini iyi bildiğimiz için Eskişehir&apos;deki projelerde şablon değil, ihtiyaca uygun mimari kuruyoruz.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-blue-500/5 border border-blue-500/15 rounded-2xl p-8">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-4">
              Eskişehir&apos;de çoğu yazılım ajansı sadece teknik iş yapar — sitenizi kurar, sizi bırakır. Biz hem teknik altyapıyı hem de
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Eskişehir&apos;de Yazılım Projenizi Konuşalım
          </h2>
