    ...
    <>
      ...
      <section className="py-16 px-6 border-t border-white/[0.06]">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-zinc-500 text-xs font-medium uppercase tracking-wider mb-5">Hizmet Verdiğimiz Şehirler</p>
          <div className="flex flex-wrap justify-center gap-3">
            {[
              { label: 'İstanbul', href: '/istanbul-dijital-pazarlama' },
              { label: 'Ankara', href: '/ankara-dijital-pazarlama' },
              { label: 'İzmir', href: '/izmir-dijital-pazarlama' },
              { label: 'Bursa', href: '/bursa-dijital-pazarlama' },
              { label: 'Antalya', href: '/antalya-dijital-pazarlama' },
              { label: 'Kocaeli', href: '/kocaeli-dijital-pazarlama' },
            ].map(({ label, href }) => (
              <Link
                key={href}
                href={href}
