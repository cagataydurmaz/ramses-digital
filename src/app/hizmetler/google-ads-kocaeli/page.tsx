...
const faqs = [
  ...
  { q: 'Yönetim ücretiniz nedir?', a: 'İki ayrı ödeme var: reklam bütçeniz (doğrudan Google\'a gider, bize ödenmez) ve bizim yönetim ücretimiz (sabit aylık ücret + reklam bütçenizin %15\'i). Örnek: aylık 20.000₺ reklam bütçeniz varsa, bizim payımız sabit ücrete ek +3.000₺ olur (20.000 × %15). İlk ay ayrıca tek seferlik kurulum ücreti alınır.' },
