...
export const metadata: Metadata = {
  title: 'Mersin Dijital Pazarlama Ajansı | 100+ Proje — Ramses Dijital',
  description:
    'Mersin\'in dijital pazarlama ajansı — 100+ proje deneyimi. SEO, Google Ads, web tasarım ve otomasyon ile lojistik, ihracat ve turizm sektörünü büyütün. Ücretsiz danışmanlık alın.',
  alternates: { canonical: 'https://ramsesdigital.com/mersin-dijital-pazarlama' },
  openGraph: {
    title: 'Mersin Dijital Pazarlama Ajansı | Ramses Dijital',
    description: 'Mersin işletmeleri için ölçülebilir dijital pazarlama. SEO, Google Ads, web ve otomasyon.',
    url: 'https://ramsesdigital.com/mersin-dijital-pazarlama',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Mersin Dijital Pazarlama — Ramses Dijital',
    description: 'Mersin\'de SEO, Google Ads, web tasarım ve pazarlama otomasyonu.',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
}
...
const channels = [
  {
    ...
    desc: 'Mersin\'deki müşterileriniz Google\'da sizi bulsun. Yerel SEO, teknik SEO, GEO ve AEO stratejileriyle organik büyüme.',
  ...
  },
  {
    ...
    desc: 'Mersin\'in rekabetçi sektörlerinde doğru kitleye hedefli reklam. Bütçenizi boşa harcamadan dönüşüm.',
    tags: ['Google Ads', 'Search', 'Display', 'Retargeting'],
    href: '/mersin-google-ads',
  },
  {
    icon: Globe,
    title: 'Web Tasarım & Geliştirme',
    desc: 'Hızlı, mobil uyumlu, dönüşüm odaklı web siteleri. Lojistik firmalarına özel hizmet ağı haritası, ihracatçılara özel çok dilli katalog altyapısı da dahil.',
  ...
  },
  {
    ...
    desc: 'Listenizi satışa dönüştüren hoşgeldin serisi, kampanya ve drip akışları. İhracat/B2B tedarikçi ilişkilerinde de etkili.',
...
const advantages = [
  { icon: MapPin, title: 'Uzaktan Çalışma Modeli', desc: 'Kocaeli merkezli olsak da tüm süreç uzaktan yürütülüyor — Mersin\'in trafiğinde toplantıya gitmenize gerek yok.' },
  ...
  { icon: Clock, title: 'Sektöre Özel Hızlı Başlangıç', desc: 'Anlaşma sonrası 5 iş günü içinde ilk çalışmalar başlar. Mersin\'in lojistik, ihracat ve turizm sektörlerine hakim strateji kurgusu.' },
]

const sectors = [
  'Lojistik & Nakliye', 'Narenciye & Tarım İhracatı', 'Gümrük Müşavirliği', 'Sahil Turizmi (Otel, Restoran)',
  'Hukuk Bürosu', 'Diş Hekimi & Diş Kliniği', 'Güzellik Merkezi & Estetik', 'Toptan Ticaret',
]

const faqs = [
  { q: 'Mersin\'de dijital pazarlamaya ne zaman başlamalıyım?', a: 'SEO otorite kazanmak zaman aldığı için erken başlamak avantaj sağlar; Mersin\'deki lojistik/ihracat rakiplerinizin bir kısmı zaten dijitale yatırım yapıyor. Küçük bir bütçeyle Google Ads ile kısa vadede trafik almak, SEO ile de uzun vadeli bir varlık inşa etmek mümkün.' },
  { q: 'Mersin\'deki hangi dijital kanal en hızlı sonuç verir?', a: 'Hızlı sonuç için Google Ads: 1-2 hafta içinde potansiyel müşteriler arar ve reklamınızı görür. Uzun vadeli ve düşük maliyetli büyüme için SEO: 3-6 ayda organik trafik birikmeye başlar. İkisini birlikte yürütmek en akıllıca stratejidir.' },
  { q: 'Lojistik firması veya narenciye ihracatçısı olarak dijital pazarlamadan nasıl fayda görürüm?', a: 'B2B alıcılar arama motorunda tedarikçi/nakliye ortağı araştırması yapıyor — "lojistik firma Mersin" veya "narenciye ihracatçı" gibi aramalar. SEO ve LinkedIn/Google Ads kombinasyonuyla bu talebi yakalamak mümkün. Sahil turizmi işletmeleri için ise görsel içerik ve rezervasyon dönüşümü ayrı bir strateji gerektiriyor.' },
  { q: 'Mersin\'de dijital pazarlama için aylık ne kadar bütçe ayırmalıyım?', a: 'Hedeflediğiniz kanal kombinasyonuna (SEO, Google Ads, web tasarım) ve sektörünüze göre değişir. Ücretsiz danışmanlıkta işletmenize özel bir bütçe planı netleştirebiliriz.' },
  ...
  { q: 'Mersin\'deki hukuk büroları, klinikler ve turizm işletmeleri için özel bir yaklaşımınız var mı?', a: 'Evet. Hukuk büroları için Avukatlık Kanunu\'nun reklam yasağı nedeniyle SEO ve içerik otoritesine dayalı strateji uyguluyoruz. Turizm işletmeleri için ise görsel ağırlıklı içerik ve mevsimsel kampanya planlaması kuruyoruz.' },
  { q: 'Uzaktan çalışıyor musunuz, yoksa Mersin\'de yerinde mi?', a: 'Tüm hizmetlerimiz uzaktan yürütülüyor. Merkezimiz Kocaeli\'de, fiziksel ofisimiz Mersin\'de yok. Toplantılar Google Meet/Zoom üzerinden, raporlar dijital dashboard ve PDF ile paylaşılıyor.' },
  { q: 'Yapay zeka reklamcılığı ve GEO nedir, Mersin işletmesi için gerekli mi?', a: 'GEO (Generative Engine Optimization), ChatGPT veya Gemini\'de "Mersin\'de [sektörünüz]" aramasında önerilmek için yapılan optimizasyondur. Bu henüz doymamış bir kanal — özellikle lojistik ve ihracat firmaları için erken hareket eden işletmeler önemli bir avantaj kazanıyor.' },
]
  ...
  '@graph': [
    {
      ...
      name: 'Ramses Dijital',
      description: 'Mersin dahil Türkiye genelinde hizmet veren dijital pazarlama ajansı. SEO, Google Ads, web tasarım ve otomasyon.',
      ...
      areaServed: [
        ...
        { '@type': 'City', name: 'Tarsus' },
        { '@type': 'City', name: 'Erdemli' },
      ],
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Mersin Dijital Pazarlama', item: 'https://ramsesdigital.com/mersin-dijital-pazarlama' },
      ],
    },
    {
      '@type': 'FAQPage',
...
export default function MersinDijitalPazarlamaPage() {
  return (
    <>
      <script
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-blue-400 text-sm font-medium">Mersin&apos;e Uzaktan Hizmet</span>
          </div>
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto mb-4 leading-relaxed">
            Mersin&apos;in liman/lojistik firmalarına ve narenciye ihracatçılarına özel SEO, Google Ads, web tasarım ve otomasyon — B2B ihracat satış huninize uygun kurgu.
          </p>
          <p className="text-zinc-500 text-sm mb-10">
            Yenişehir · Akdeniz · Toroslar · Mezitli · Tarsus · Erdemli · Silifke
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Mersin İşletmenizi Büyütecek Kanallar
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto">
              Liman ve ihracat ağırlıklı Mersin pazarında B2B satış döngüsü uzun — doğru kanal kombinasyonu bu süreci kısaltır.
            </p>
          </div>
      ...
      <section className="py-16 px-6 bg-[#080D18]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-white mb-3">Mersin&apos;de Hizmet Verdiğimiz Sektörler</h2>
          <p className="text-zinc-500 text-sm mb-8">Liman/lojistik ve ihracatın operasyonel diliyle konuşuyoruz, jenerik pazarlama kalıplarıyla değil.</p>
      ...
      <section className="py-20 px-6 bg-[#080D18]">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Mersin&apos;de Dijital Büyümeye Başlayın
          </h2>
