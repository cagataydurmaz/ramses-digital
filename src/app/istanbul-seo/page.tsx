...
const faqs = [
  ...
  { q: 'İstanbul SEO paketi ne kadara mal olur?', a: 'İstanbul\'daki rekabet seviyesi nedeniyle paketler genellikle Kocaeli\'ye göre daha kapsamlı kurgulanır: aylık 10.000-25.000 TL arası. Kurumsal veya çok şubeli projeler 30.000+ TL olabilir. Kapsam: teknik audit, anahtar kelime araştırması, aylık içerik üretimi, GBP yönetimi, backlink stratejisi ve raporlama.' },
