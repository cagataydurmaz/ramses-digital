...
export const metadata: Metadata = {
  title: 'Gaziantep Yazılım Ajansı — Ramses Dijital',
  description:
    'Gaziantep\'te yazılım ajansı. Web uygulaması, otomasyon, API entegrasyonu ve dijital pazarlama yazılımları. Tekstil ihracatçıları, gıda üreticileri ve KOBİ\'ler için özel yazılım çözümleri.',
  alternates: { canonical: 'https://ramsesdigital.com/gaziantep-yazilim-ajansi' },
  openGraph: {
    title: 'Gaziantep Yazılım Ajansı | Ramses Dijital',
    description: 'Gaziantep işletmeleri için özel yazılım, web uygulaması ve otomasyon çözümleri.',
    url: 'https://ramsesdigital.com/gaziantep-yazilim-ajansi',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
}

const solutions = [
  { icon: Globe, title: 'Web Uygulaması & Site', desc: 'Next.js ile yüksek performanslı web siteleri ve uygulamalar. Ürün kataloğundan çok dilli B2B ihracat portalına kadar.' },
  ...
  { icon: Layers, title: 'API Entegrasyonu', desc: 'Muhasebe yazılımı, ERP, e-ticaret altyapısı, ödeme ve kargo/ihracat sistemleri — mevcut araçlarınızı birbirine bağlayın.' },
...
const faqs = [
  { q: 'Gaziantep\'te yazılım ajansı ile çalışmanın avantajı ne?', a: 'Uzaktan çalışıyoruz, dolayısıyla coğrafi mesafe kısıtımız yok. Ancak Gaziantep\'in tekstil/halı ihracatı, gıda üretimi (özellikle baklava ve antep fıstığı) ve plastik/ambalaj sanayii sektörlerine özgü operasyonel ihtiyaçları — ihracat belgeleri, çok dilli sipariş yönetimi, toptan/perakende ayrımı — bilmek büyük fark yaratıyor. Bu sektörlere özel çözüm önerileri sunuyoruz.' },
  { q: 'Özel yazılım mı, hazır SaaS mi kullanmalıyım?', a: 'Çoğu durumda ikisinin kombinasyonu en akıllıcasıdır. Muhasebe, CRM, e-posta gibi alanlarda Parasut, HubSpot, Mailchimp gibi SaaS araçları uygun maliyetli. İhracat takibi, çok dilli katalog, özel raporlama gibi Gaziantep\'in ihracat ağırlıklı işletmelerine özgü süreçler için özel yazılım veya otomasyon daha verimli.' },
  { q: 'Projeyi teslim ettikten sonra destek veriyor musunuz?', a: 'Evet. Teslim sonrası 1-3 ay hata düzeltme garantisi kapsamda. İhracat firmalarının gümrük/lojistik entegrasyonları canlı sistem olduğu için, aylık bakım paketiyle güncelleme, küçük geliştirme ve teknik izlemeyi sürekli tutuyoruz.' },
  ...
  { q: 'Mevcut yazılımımla entegrasyon yapabilir misiniz?', a: 'Büyük ihtimalle evet. Mikro Yazılım, Logo, SAP, WooCommerce, Shopify, Trendyol, Hepsiburada entegrasyonlarında deneyimimiz var. Gaziantep\'in ihracat firmalarının kullandığı gümrük/lojistik sistemleriyle de API veya webhook bazlı entegrasyon kurabiliriz.' },
  { q: 'Yazılım projesine nasıl başlanıyor?', a: 'Önce 30 dakikalık ücretsiz bir görüşmeyle mevcut iş akışınızı ve hangi sistemle (ERP, ihracat takip, bayi portalı vb.) entegre çalışacağımızı netleştiriyoruz. Ardından teknik şartname ve tahmini süreyi paylaşıyor, onayınızla geliştirmeye başlıyoruz. Taahhüt gerektirmez.' },
  { q: 'Fiziksel olarak Gaziantep\'te ofisiniz var mı?', a: 'Hayır, merkezimiz Kocaeli\'de — Gaziantep\'e tamamen uzaktan hizmet veriyoruz. Keşif görüşmesi ve teknik şartname süreci Google Meet/Zoom üzerinden yürütülüyor.' },
  { q: 'Kaynak kod kimin mülkiyetinde olur?', a: 'Sizin. İhracat/gümrük entegrasyonu gibi kritik sistemlerde bu özellikle önemli — kodun ve verinin size ait olduğundan emin olmanızı sağlıyoruz, bizimle çalışmaya devam etmek zorunda kalmazsınız.' },
]
...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'Service',
      name: 'Gaziantep Yazılım Ajansı Hizmetleri',
      description: 'Gaziantep işletmeleri için web uygulaması, otomasyon, API entegrasyonu ve yapay zeka çözümleri.',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Gaziantep Yazılım Ajansı', item: 'https://ramsesdigital.com/gaziantep-yazilim-ajansi' },
      ],
    },
    {
      '@type': 'FAQPage',
...
export default function GaziantepYazilimAjansiPage() {
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            Gaziantep işletmeleri için web uygulaması, iş süreçleri otomasyonu, API entegrasyonu ve yapay zeka çözümleri. Tekstil ihracatı ve gıda üretiminin operasyonel ihtiyaçlarını biliyoruz.
          </p>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl px-6 py-4 text-center">
            <p className="text-zinc-400 text-sm leading-relaxed">
              Ramses Dijital, reklam ajansı kimliğiyle başladı; bugün SEO ve Google Ads&apos;in yanında yazılım geliştirmeyi de aynı disiplinle sunuyor. Gaziantep&apos;te tekstil ve gıda ihracatçılarıyla çalışırken ihracat/lojistik süreçlerinin dijitalleşme ihtiyacını doğrudan gördük.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Gaziantep İçin Yazılım Çözümleri
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto">
              İhracat süreçleri ve toptan/perakende operasyonlarını iyi bildiğimiz için Gaziantep&apos;teki projelerde şablon değil, ihtiyaca uygun mimari kuruyoruz.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-blue-500/5 border border-blue-500/15 rounded-2xl p-8">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-4">
              Gaziantep&apos;te çoğu yazılım ajansı sadece teknik iş yapar — sitenizi kurar, sizi bırakır. Biz hem teknik altyapıyı hem de
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Gaziantep&apos;te Yazılım Projenizi Konuşalım
          </h2>
