...
const faqs = [
  ...
  { q: 'Google Ads için ne kadar bütçe ayırmalıyım?', a: 'Sektöre ve rekabet düzeyine göre değişir — yerel hizmet işletmeleri ile ulusal ölçekte rekabetçi sektörler farklı bütçe seviyeleri gerektirir. Ajans yönetim ücreti reklam bütçesinden ayrıdır. Ücretsiz danışmanlıkta sektörünüze özel öneri sunuyoruz.' },
