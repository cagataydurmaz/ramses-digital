...
const faqs = [
  ...
  { q: 'Google Ads için ne kadar bütçe ayırmalıyım?', a: 'Sektöre ve rekabet düzeyine göre değişir — yerel hizmet işletmeleri ile ulusal ölçekte rekabetçi sektörler farklı bütçe seviyeleri gerektirir. Reklam bütçeniz doğrudan Google\'a gider, bize hiç uğramaz — bizim ücretimiz ayrı bir kalem: sabit aylık ücret + bütçenizin %15\'i (örnek: 20.000₺ bütçede +3.000₺). Ücretsiz danışmanlıkta sektörünüze özel öneri sunuyoruz.' },
