...
export const metadata: Metadata = {
  ...
  title: 'Ramses Digital | İzmit & Kocaeli Dijital Pazarlama Ajansı — SEO, Google Ads, n8n',
  description:
    'İzmit Kocaeli\'nin performans odaklı dijital pazarlama ajansı. SEO, Google Ads, n8n otomasyon, web tasarımı ve sosyal medya yönetiminde uzman. Ücretsiz danışmanlık.',
  keywords:
  ...
  applicationName: 'Ramses Digital',
  authors: [{ name: 'Ramses Digital', url: 'https://ramsesdigital.com' }],
  creator: 'Ramses Digital',
  publisher: 'Ramses Digital',
  ...
  themeColor: '#0A0F1E',
  openGraph: {
    title: 'Ramses Digital | İzmit Kocaeli Dijital Pazarlama Ajansı',
    description: 'İzmit & Kocaeli merkezli dijital pazarlama ajansı — SEO, Google Ads, n8n otomasyon, web tasarım. Markanızı dijitalde büyütün.',
    locale: 'tr_TR',
    type: 'website',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Ramses Digital — İzmit Kocaeli Dijital Pazarlama Ajansı',
      },
    ],
  },
  twitter: {
