...
const faqs = [
  ...
  { q: 'İzmir\'de web sitesi fiyatları ne kadar?', a: 'Başlangıç paketleri 15.000 TL\'den, kurumsal 25.000 TL\'den, e-ticaret 40.000 TL\'den başlıyor. Domain ve hosting ayrıdır.' },
