...
export const metadata: Metadata = {
  title: 'Mersin Yazılım Ajansı — Ramses Dijital',
  description:
    'Mersin\'de yazılım ajansı. Web uygulaması, otomasyon, API entegrasyonu ve dijital pazarlama yazılımları. Lojistik firmaları, ihracatçılar ve KOBİ\'ler için özel yazılım çözümleri.',
  alternates: { canonical: 'https://ramsesdigital.com/mersin-yazilim-ajansi' },
  openGraph: {
    title: 'Mersin Yazılım Ajansı | Ramses Dijital',
    description: 'Mersin işletmeleri için özel yazılım, web uygulaması ve otomasyon çözümleri.',
    url: 'https://ramsesdigital.com/mersin-yazilim-ajansi',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
}

const solutions = [
  { icon: Globe, title: 'Web Uygulaması & Site', desc: 'Next.js ile yüksek performanslı web siteleri ve uygulamalar. Hizmet ağı haritasından çok dilli ihracat portalına kadar.' },
  { icon: Zap, title: 'İş Süreçleri Otomasyonu', desc: 'n8n ile tekrarlayan operasyonları otomatikleştirin. Sevkiyat takibi, CRM, e-posta, bildirim ve fatura akışları.' },
  { icon: Layers, title: 'API Entegrasyonu', desc: 'Muhasebe yazılımı, ERP, gümrük/lojistik sistemleri, ödeme altyapıları — mevcut araçlarınızı birbirine bağlayın.' },
  { icon: BarChart3, title: 'Veri & Analitik', desc: 'GA4, Looker Studio ve özel dashboard\'lar. Sevkiyat, satış ve pazarlama verinizi görsel ve anlaşılır hale getirin.' },
...
const faqs = [
  { q: 'Mersin\'de yazılım ajansı ile çalışmanın avantajı ne?', a: 'Uzaktan çalışıyoruz, dolayısıyla coğrafi mesafe kısıtımız yok. Ancak Mersin\'in liman/lojistik ve narenciye ihracatı sektörlerine özgü operasyonel ihtiyaçları — sevkiyat takibi, gümrük belgeleri, çok dilli sipariş yönetimi — bilmek büyük fark yaratıyor. Bu sektörlere özel çözüm önerileri sunuyoruz.' },
  { q: 'Özel yazılım mı, hazır SaaS mi kullanmalıyım?', a: 'Çoğu durumda ikisinin kombinasyonu en akıllıcasıdır. Muhasebe, CRM, e-posta gibi alanlarda Parasut, HubSpot, Mailchimp gibi SaaS araçları uygun maliyetli. Sevkiyat/gümrük takibi, çok dilli katalog gibi Mersin\'in lojistik ve ihracat ağırlıklı işletmelerine özgü süreçler için özel yazılım veya otomasyon daha verimli.' },
  { q: 'Projeyi teslim ettikten sonra destek veriyor musunuz?', a: 'Evet. Teslim sonrası 1-3 ay hata düzeltme garantisi kapsamda. Lojistik firmalarının gümrük/nakliye entegrasyonları canlı sistem olduğu için, aylık bakım paketiyle güncelleme, küçük geliştirme ve teknik izlemeyi sürekli tutuyoruz.' },
  ...
  { q: 'Mevcut yazılımımla entegrasyon yapabilir misiniz?', a: 'Büyük ihtimalle evet. Mikro Yazılım, Logo, SAP, WooCommerce, Shopify, Trendyol, Hepsiburada entegrasyonlarında deneyimimiz var. Mersin\'in lojistik firmalarının kullandığı gümrük/nakliye sistemleriyle de API veya webhook bazlı entegrasyon kurabiliriz.' },
  { q: 'Yazılım projesine nasıl başlanıyor?', a: 'Önce 30 dakikalık ücretsiz bir görüşmeyle mevcut iş akışınızı ve hangi sistemle (ERP, sevkiyat takip, bayi portalı vb.) entegre çalışacağımızı netleştiriyoruz. Ardından teknik şartname ve tahmini süreyi paylaşıyor, onayınızla geliştirmeye başlıyoruz. Taahhüt gerektirmez.' },
  { q: 'Fiziksel olarak Mersin\'de ofisiniz var mı?', a: 'Hayır, merkezimiz Kocaeli\'de — Mersin\'e tamamen uzaktan hizmet veriyoruz. Keşif görüşmesi ve teknik şartname süreci Google Meet/Zoom üzerinden yürütülüyor.' },
  { q: 'Kaynak kod kimin mülkiyetinde olur?', a: 'Sizin. Gümrük/lojistik entegrasyonu gibi kritik sistemlerde bu özellikle önemli — kodun ve verinin size ait olduğundan emin olmanızı sağlıyoruz, bizimle çalışmaya devam etmek zorunda kalmazsınız.' },
]
...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'Service',
      name: 'Mersin Yazılım Ajansı Hizmetleri',
      description: 'Mersin işletmeleri için web uygulaması, otomasyon, API entegrasyonu ve yapay zeka çözümleri.',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Mersin Yazılım Ajansı', item: 'https://ramsesdigital.com/mersin-yazilim-ajansi' },
      ],
    },
    {
      '@type': 'FAQPage',
...
export default function MersinYazilimAjansiPage() {
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
            Mersin Yazılım Ajansı
            <br />
            <span className="gradient-text">Web, Otomasyon & AI</span>
          </h1>
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            Mersin işletmeleri için web uygulaması, iş süreçleri otomasyonu, API entegrasyonu ve yapay zeka çözümleri. Liman/lojistik ve ihracatın operasyonel ihtiyaçlarını biliyoruz.
          </p>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white/[0.02] border border-white/[0.06] rounded-xl px-6 py-4 text-center">
            <p className="text-zinc-400 text-sm leading-relaxed">
              Ramses Dijital, reklam ajansı kimliğiyle başladı; bugün SEO ve Google Ads&apos;in yanında yazılım geliştirmeyi de aynı disiplinle sunuyor. Mersin&apos;de lojistik ve ihracatçı firmalarla çalışırken sevkiyat/gümrük süreçlerinin dijitalleşme ihtiyacını doğrudan gördük.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Mersin İçin Yazılım Çözümleri
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto">
              Sevkiyat takibi ve ihracat süreçlerini iyi bildiğimiz için Mersin&apos;deki projelerde şablon değil, ihtiyaca uygun mimari kuruyoruz.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-blue-500/5 border border-blue-500/15 rounded-2xl p-8">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-4">
              Mersin&apos;de çoğu yazılım ajansı sadece teknik iş yapar — sitenizi kurar, sizi bırakır. Biz hem teknik altyapıyı hem de
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Mersin&apos;de Yazılım Projenizi Konuşalım
          </h2>
