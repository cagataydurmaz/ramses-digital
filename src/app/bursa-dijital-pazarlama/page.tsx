...
export const metadata: Metadata = {
  title: 'Bursa Dijital Pazarlama Ajansı | 100+ Proje — Ramses Dijital',
  description:
    'Bursa\'nın dijital pazarlama ajansı — 100+ proje deneyimi. SEO, Google Ads, web tasarım ve otomasyon ile otomotiv, mobilya ve tekstil sektörünü büyütün. Ücretsiz danışmanlık alın.',
  alternates: { canonical: 'https://ramsesdigital.com/bursa-dijital-pazarlama' },
  openGraph: {
    title: 'Bursa Dijital Pazarlama Ajansı | Ramses Dijital',
    description: 'Bursa işletmeleri için ölçülebilir dijital pazarlama. SEO, Google Ads, web ve otomasyon.',
    url: 'https://ramsesdigital.com/bursa-dijital-pazarlama',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Bursa Dijital Pazarlama — Ramses Dijital',
    description: 'Bursa\'da SEO, Google Ads, web tasarım ve pazarlama otomasyonu.',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
}
...
const channels = [
  {
    ...
    desc: 'Bursa\'daki müşterileriniz Google\'da sizi bulsun. Yerel SEO, teknik SEO, GEO ve AEO stratejileriyle organik büyüme.',
  ...
  },
  {
    ...
    desc: 'Bursa\'nın rekabetçi sektörlerinde doğru kitleye hedefli reklam. Bütçenizi boşa harcamadan dönüşüm.',
    tags: ['Google Ads', 'Search', 'Display', 'Retargeting'],
    href: '/bursa-google-ads',
  },
  {
    icon: Globe,
    title: 'Web Tasarım & Geliştirme',
    desc: 'Hızlı, mobil uyumlu, dönüşüm odaklı web siteleri. Otomotiv yan sanayi ve mobilya üreticilerine özel katalog altyapısı da dahil.',
...
const advantages = [
  { icon: MapPin, title: 'Uzaktan Çalışma Modeli', desc: 'Kocaeli merkezli olsak da tüm süreç uzaktan yürütülüyor — Bursa\'nın trafiğinde toplantıya gitmenize gerek yok.' },
  ...
  { icon: Clock, title: 'Sektöre Özel Hızlı Başlangıç', desc: 'Anlaşma sonrası 5 iş günü içinde ilk çalışmalar başlar. Bursa\'nın otomotiv, mobilya ve tekstil sektörlerine hakim strateji kurgusu.' },
]

const sectors = [
  'Otomotiv Yan Sanayi', 'Mobilya Üreticileri', 'Tekstil Firmaları', 'Hukuk Bürosu',
  'Diş Hekimi & Diş Kliniği', 'Psikolog & Terapist', 'Güzellik Merkezi & Estetik', 'Gıda Sanayii',
]
...
const faqs = [
  ...
  { q: 'Bursa\'daki hukuk büroları, klinikler ve estetik merkezleri için özel bir yaklaşımınız var mı?', a: 'Evet. Hukuk büroları için Avukatlık Kanunu\'nun reklam yasağı nedeniyle SEO ve içerik otoritesine dayalı strateji uyguluyoruz. Diş hekimi, psikolog ve estetik merkezleri için ise güven inşa eden içerik ve yerel SEO ağırlıklı bir yaklaşım kuruyoruz.' },
  { q: 'Uzaktan çalışıyor musunuz, yoksa Bursa\'da yerinde mi?', a: 'Tüm hizmetlerimiz uzaktan yürütülüyor. Merkezimiz Kocaeli\'de, fiziksel ofisimiz Bursa\'da yok. Toplantılar Google Meet/Zoom üzerinden, raporlar dijital dashboard ve PDF ile paylaşılıyor.' },
  { q: 'Yapay zeka reklamcılığı ve GEO nedir, Bursa işletmesi için gerekli mi?', a: 'GEO (Generative Engine Optimization), ChatGPT veya Gemini\'de "Bursa\'da [sektörünüz]" aramasında önerilmek için yapılan optimizasyondur. Bu henüz doymamış bir kanal — erken hareket eden işletmeler önemli bir avantaj kazanıyor.' },
]
  ...
  '@graph': [
    {
      ...
      name: 'Ramses Dijital',
      description: 'Bursa dahil Türkiye genelinde hizmet veren dijital pazarlama ajansı. SEO, Google Ads, web tasarım ve otomasyon.',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Bursa Dijital Pazarlama', item: 'https://ramsesdigital.com/bursa-dijital-pazarlama' },
      ],
    },
    {
      '@type': 'FAQPage',
...
export default function BursaDijitalPazarlamaPage() {
  return (
    <>
      <script
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-blue-400 text-sm font-medium">Bursa&apos;ya Uzaktan Hizmet</span>
          </div>
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto mb-4 leading-relaxed">
            Bursa&apos;nın otomotiv yan sanayi, mobilya ve tekstil üreticilerine özel SEO, Google Ads, web tasarım ve otomasyon — B2B satış huninize uygun kurgu.
          </p>
          <p className="text-zinc-500 text-sm mb-10">
            Osmangazi · Nilüfer · Yıldırım · Gemlik · İnegöl · Mudanya · Orhangazi
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Bursa İşletmenizi Büyütecek Kanallar
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto">
              Üretim ağırlıklı Bursa pazarında B2B satış döngüsü uzun — doğru kanal kombinasyonu bu süreci kısaltır.
            </p>
          </div>
      ...
      <section className="py-16 px-6 bg-[#080D18]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-white mb-3">Bursa&apos;da Hizmet Verdiğimiz Sektörler</h2>
          <p className="text-zinc-500 text-sm mb-8">Otomotiv yan sanayi ve mobilya üretiminin operasyonel diliyle konuşuyoruz, jenerik pazarlama kalıplarıyla değil.</p>
      ...
      <section className="py-20 px-6 bg-[#080D18]">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Bursa&apos;da Dijital Büyümeye Başlayın
          </h2>
