...
const faqs = [
  ...
  { q: 'Projeyi teslim ettikten sonra destek veriyor musunuz?', a: 'Evet. Teslim sonrası 1-3 ay hata düzeltme garantisi kapsamda. Otomotiv yan sanayi ve üretim firmalarının ERP/tedarik zinciri entegrasyonları canlı sistem olduğu için, aylık bakım paketiyle güncelleme, küçük geliştirme ve teknik izlemeyi sürekli tutuyoruz.' },
