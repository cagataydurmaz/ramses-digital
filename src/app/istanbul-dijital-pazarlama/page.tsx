...
İstanbul&apos;un aşırı rekabetçi dijital pazarında öne çıkmak için SEO, Google Ads, web tasarım ve otomasyonu tek stratejide birleştiriyoruz.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-400 max-w-xl mx-auto">
              15+ milyonluk pazarda görünürlük tek kanalla gelmiyor — doğru kombinasyon rekabette öne çıkarır.
            </p>
          </div>
      ...
      <section className="py-16 px-6 bg-[#080D18]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-zinc-500 text-sm mb-8">Portföyümüzdeki İstanbul Barosu&apos;na kayıtlı avukat müşterilerimiz, reklamı kısıtlı sektörlerde bile sonuç aldığımızın kanıtı.</p>
