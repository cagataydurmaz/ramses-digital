...
export const metadata: Metadata = {
  ...
  description:
    'İstanbul\'un dijital pazarlama ajansı. SEO, Google Ads, web tasarım, e-posta ve otomasyon hizmetleriyle işletmenizi büyütün. Kocaeli merkezli, İstanbul dahil Türkiye geneli uzaktan hizmet.',
...
const faqs = [
  ...
  { q: 'İstanbul\'da dijital pazarlama için aylık ne kadar bütçe ayırmalıyım?', a: 'İstanbul\'un rekabet seviyesi nedeniyle Kocaeli\'ye göre daha yüksek bütçe gerekir: Google Ads + yönetim + SEO kombinasyonu aylık 15.000-30.000 TL aralığında. Sadece SEO 10.000-25.000 TL, sadece Google Ads 8.000+ TL reklam bütçesi + yönetim ücreti. Sektöre göre ücretsiz danışmanlıkta netleştirebiliriz.' },
