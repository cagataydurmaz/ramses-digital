...
export const metadata: Metadata = {
  title: 'Eskişehir Reklam Ajansı | 100+ Proje — Ramses Dijital',
  description:
    'Eskişehir\'in dijital reklam ajansı — öğrenci pazarı ve sanayi sektörüne özel strateji. Google Ads, SEO ve pazarlama otomasyonu. Ücretsiz teklif alın.',
  alternates: { canonical: 'https://ramsesdigital.com/eskisehir-reklam-ajansi' },
  openGraph: {
    title: 'Eskişehir Reklam Ajansı | Ramses Dijital',
    description: 'Eskişehir\'de işletmenizi büyüten dijital reklam ajansı. Google Ads, SEO, web tasarım ve otomasyon.',
    url: 'https://ramsesdigital.com/eskisehir-reklam-ajansi',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Eskişehir Reklam Ajansı — Ramses Dijital',
    description: 'Eskişehir işletmeleri için dijital pazarlama, Google Ads, SEO.',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
}

const services = [
  { icon: Search, title: 'SEO & Yerel SEO', desc: 'Google\'da "Eskişehir + sektörünüz" aramalarında üst sıralarda çıkın. Google Business Profile yönetimi dahil.', href: '/eskisehir-seo' },
  { icon: Megaphone, title: 'Google Ads', desc: 'Eskişehir\'de potansiyel müşterilere tam doğru anda ulaşın. Reklam bütçenizi boşa harcamayın.', href: '/eskisehir-google-ads' },
  { icon: Globe, title: 'Web Tasarım', desc: 'Dönüşüm odaklı, hızlı yüklenen web siteleri. Mobil uyumlu, SEO hazır.', href: '/eskisehir-web-tasarim' },
...
const whyUs = [
  { icon: MapPin, title: 'Eskişehir\'in Sektörel Kimliğini Biliyoruz', desc: 'Öğrenci pazarının ve demiryolu/havacılık sanayinin dinamiklerini anlayan bir ekiple çalışıyorsunuz. Genel şablon yok.' },
  { icon: Users, title: 'Türkiye Genelinde Kanıtlanmış Referanslar', desc: 'Eskişehir\'e özel vaka çalışmamız henüz yok, ama Türkiye genelinde canlı, ziyaret edilebilir projelerimiz var.' },
...
const faqs = [
  { q: 'Eskişehir\'de reklam ajansı seçerken nelere dikkat etmeliyim?', a: 'En önemli kriter gerçek referanslar ve şeffaf raporlamadır. Ajansın sektörünüze (örneğin öğrenci pazarı veya sanayi) daha önce çalışıp çalışmadığını, somut sonuçlar sunup sunamadığını ve aylık raporlama yapıp yapmadığını sormalısınız. Sözleşme imzalamadan önce canlı müşteri sitelerine mutlaka bakın.' },
  { q: 'Eskişehir\'de dijital reklamın maliyeti nedir?', a: 'Google Ads reklam bütçesi, SEO yönetim ücreti ve web sitesi maliyeti işletmenizin büyüklüğüne ve hedeflerinize göre değişir. Ücretsiz danışmanlık seansında size özel bilgi paylaşıyoruz.' },
  { q: 'Eskişehir\'deki işletmem için Google\'da nasıl üst sıralara çıkarım?', a: 'İki paralel strateji gerekli: Google Business Profile optimizasyonu (harita paketi için) ve web sitesi SEO\'su (organik arama için). GBP için işletme bilgilerini eksiksiz doldurmak, müşteri yorumları toplamak ve yerel dizinlere kayıt olmak kritiktir. Web sitesi için Eskişehir\'e özel içerik üretmek şarttır.' },
  { q: 'Eskişehir\'de hangi sektörlere hizmet veriyorsunuz?', a: 'Eskişehir\'in güçlü sektörleri olan öğrenciye hitap eden işletmeler (kafe, kırtasiye, kurs merkezi), demiryolu/havacılık yan sanayi ve kültür-sanat işletmelerinin yanında hukuk, diş hekimliği ve güzellik & estetik gibi alanlarda da çalışıyoruz. Sektöre özel strateji kuruyoruz, şablon uygulamıyoruz.' },
  ...
  { q: 'Eskişehir\'in hangi ilçelerine hizmet veriyorsunuz?', a: 'Odunpazarı, Tepebaşı, Sivrihisar, Mihalıççık, Çifteler, Sarıcakaya, Alpu ve Mihalgazi dahil Eskişehir\'in tüm ilçelerine uzaktan hizmet veriyoruz.' },
  ...
  { q: 'Yapay zeka (ChatGPT, Gemini) aramalarında da görünür olabilir miyim?', a: 'Evet, bu GEO (Generative Engine Optimization) olarak adlandırılıyor. Eskişehir\'de sektörünüzü araştıran birinin ChatGPT\'ye sorduğunda sizi önermesi için yapılandırılmış içerik, citation-worthy veriler ve otoriter backlink profili gerekiyor. Tüm SEO paketlerimize GEO stratejisi dahildir.' },
  { q: 'Fiziksel olarak Eskişehir\'de ofisiniz var mı?', a: 'Hayır, merkezimiz Kocaeli\'de — Eskişehir\'e tamamen uzaktan hizmet veriyoruz. Keşif görüşmesi, strateji onayı ve raporlama Google Meet/Zoom üzerinden yürütülüyor.' },
  { q: 'Reklam hesabımız kimin adına açılır?', a: 'Firmanızın adına. Google Ads hesabı sizde açılır, biz yönetici olarak erişiriz. Hesap üzerinde tam kontrol her zaman sizde kalır.' },
]
  ...
  '@graph': [
    {
      ...
      name: 'Ramses Dijital',
      description: 'Eskişehir\'in dijital reklam ve pazarlama ajansı — uzaktan hizmet',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Eskişehir Reklam Ajansı', item: 'https://ramsesdigital.com/eskisehir-reklam-ajansi' },
      ],
    },
    {
      '@type': 'FAQPage',
...
export default function EskisehirReklamAjansiPage() {
  return (
    <>
      <script
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto mb-4 leading-relaxed">
            Google Ads, SEO, web tasarım ve pazarlama otomasyonu ile Eskişehir işletmelerini dijitalde büyütüyoruz. Öğrenci pazarı ve sanayi sektörüne özel strateji.
          </p>
          <p className="text-zinc-500 text-sm mb-10">
            Odunpazarı · Tepebaşı · Sivrihisar · Mihalıççık · Çifteler · Sarıcakaya · Alpu
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Eskişehir İşletmeniz İçin Tüm Dijital Hizmetler
            </h2>
      ...
      <section className="py-20 px-6 bg-[#080D18]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Neden Eskişehir&apos;deki İşletmeler Bizi Seçiyor?
            </h2>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-blue-500/5 border border-blue-500/15 rounded-2xl p-8 text-center">
            ...
            <p className="text-zinc-400 mb-6 max-w-xl mx-auto text-sm leading-relaxed">
              Eskişehir&apos;e özel bir vaka çalışmamız henüz yok — bunu saklamıyoruz. Ancak Türkiye genelinde
              ziyaret edilebilir, canlı SEO ve web tasarım projelerimiz var. Portföyümüzü inceleyip aynı
              mühendislik disipliniyle Eskişehir işletmeniz için nasıl çalışacağımızı görebilirsiniz.
            </p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Eskişehir&apos;de Dijitalde Öne Çıkmaya Hazır mısınız?
          </h2>
