...
export const metadata: Metadata = {
  title: 'Gaziantep Dijital Pazarlama Ajansı | 100+ Proje — Ramses Dijital',
  description:
    'Gaziantep\'in dijital pazarlama ajansı — 100+ proje deneyimi. SEO, Google Ads, web tasarım ve otomasyon ile tekstil, gıda ve ihracat sektörünü büyütün. Ücretsiz danışmanlık alın.',
  alternates: { canonical: 'https://ramsesdigital.com/gaziantep-dijital-pazarlama' },
  openGraph: {
    title: 'Gaziantep Dijital Pazarlama Ajansı | Ramses Dijital',
    description: 'Gaziantep işletmeleri için ölçülebilir dijital pazarlama. SEO, Google Ads, web ve otomasyon.',
    url: 'https://ramsesdigital.com/gaziantep-dijital-pazarlama',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Gaziantep Dijital Pazarlama — Ramses Dijital',
    description: 'Gaziantep\'te SEO, Google Ads, web tasarım ve pazarlama otomasyonu.',
    images: ['https://ramsesdigital.com/og-image.png'],
  },
}
...
const channels = [
  {
    ...
    desc: 'Gaziantep\'teki müşterileriniz Google\'da sizi bulsun. Yerel SEO, teknik SEO, GEO ve AEO stratejileriyle organik büyüme.',
  ...
  },
  {
    ...
    desc: 'Gaziantep\'in rekabetçi sektörlerinde doğru kitleye hedefli reklam. Bütçenizi boşa harcamadan dönüşüm.',
    tags: ['Google Ads', 'Search', 'Display', 'Retargeting'],
    href: '/gaziantep-google-ads',
  },
  {
    icon: Globe,
    title: 'Web Tasarım & Geliştirme',
    desc: 'Hızlı, mobil uyumlu, dönüşüm odaklı web siteleri. Tekstil ve gıda ihracatçılarına özel çok dilli katalog altyapısı da dahil.',
...
const advantages = [
  { icon: MapPin, title: 'Uzaktan Çalışma Modeli', desc: 'Kocaeli merkezli olsak da tüm süreç uzaktan yürütülüyor — Gaziantep\'in trafiğinde toplantıya gitmenize gerek yok.' },
  ...
  { icon: Clock, title: 'Sektöre Özel Hızlı Başlangıç', desc: 'Anlaşma sonrası 5 iş günü içinde ilk çalışmalar başlar. Gaziantep\'in tekstil, gıda ve ihracat sektörlerine hakim strateji kurgusu.' },
]

const sectors = [
  'Tekstil & Halı İhracatı', 'Gıda Üreticileri (Baklava, Antep Fıstığı)', 'Plastik & Ambalaj Sanayii', 'Hukuk Bürosu',
  'Diş Hekimi & Diş Kliniği', 'Güzellik Merkezi & Estetik', 'Gastronomi Turizmi', 'Toptan Ticaret',
]

const faqs = [
  { q: 'Gaziantep\'te dijital pazarlamaya ne zaman başlamalıyım?', a: 'SEO otorite kazanmak zaman aldığı için erken başlamak avantaj sağlar; Gaziantep\'teki ihracatçı rakiplerinizin bir kısmı zaten dijitale yatırım yapıyor. Küçük bir bütçeyle Google Ads ile kısa vadede trafik almak, SEO ile de uzun vadeli bir varlık inşa etmek mümkün.' },
  { q: 'Gaziantep\'teki hangi dijital kanal en hızlı sonuç verir?', a: 'Hızlı sonuç için Google Ads: 1-2 hafta içinde potansiyel müşteriler arar ve reklamınızı görür. Uzun vadeli ve düşük maliyetli büyüme için SEO: 3-6 ayda organik trafik birikmeye başlar. İkisini birlikte yürütmek en akıllıca stratejidir.' },
  { q: 'Tekstil ihracatçısı veya gıda üreticisi olarak dijital pazarlamadan nasıl fayda görürüm?', a: 'B2B alıcılar arama motorunda tedarikçi araştırması yapıyor — "tekstil ihracatçı Gaziantep" veya "baklava toptan üretici" gibi aramalar. SEO ve LinkedIn/Google Ads kombinasyonuyla bu talebi yakalamak mümkün. Gıda üreticileri için ise hem B2B toptan hem B2C perakende/e-ticaret talebi ayrı stratejiler gerektiriyor.' },
  { q: 'Gaziantep\'te dijital pazarlama için aylık ne kadar bütçe ayırmalıyım?', a: 'Hedeflediğiniz kanal kombinasyonuna (SEO, Google Ads, web tasarım) ve sektörünüze göre değişir. Ücretsiz danışmanlıkta işletmenize özel bir bütçe planı netleştirebiliriz.' },
  ...
  { q: 'Gaziantep\'teki hukuk büroları, klinikler ve estetik merkezleri için özel bir yaklaşımınız var mı?', a: 'Evet. Hukuk büroları için Avukatlık Kanunu\'nun reklam yasağı nedeniyle SEO ve içerik otoritesine dayalı strateji uyguluyoruz. Diş hekimi ve estetik merkezleri için ise güven inşa eden içerik ve yerel SEO ağırlıklı bir yaklaşım kuruyoruz.' },
  { q: 'Uzaktan çalışıyor musunuz, yoksa Gaziantep\'te yerinde mi?', a: 'Tüm hizmetlerimiz uzaktan yürütülüyor. Merkezimiz Kocaeli\'de, fiziksel ofisimiz Gaziantep\'te yok. Toplantılar Google Meet/Zoom üzerinden, raporlar dijital dashboard ve PDF ile paylaşılıyor.' },
  { q: 'Yapay zeka reklamcılığı ve GEO nedir, Gaziantep işletmesi için gerekli mi?', a: 'GEO (Generative Engine Optimization), ChatGPT veya Gemini\'de "Gaziantep\'te [sektörünüz]" aramasında önerilmek için yapılan optimizasyondur. Bu henüz doymamış bir kanal — özellikle ihracat firmaları için erken hareket eden işletmeler önemli bir avantaj kazanıyor.' },
]
  ...
  '@graph': [
    {
      ...
      name: 'Ramses Dijital',
      description: 'Gaziantep dahil Türkiye genelinde hizmet veren dijital pazarlama ajansı. SEO, Google Ads, web tasarım ve otomasyon.',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Gaziantep Dijital Pazarlama', item: 'https://ramsesdigital.com/gaziantep-dijital-pazarlama' },
      ],
    },
    {
      '@type': 'FAQPage',
...
export default function GaziantepDijitalPazarlamaPage() {
  return (
    <>
      <script
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-blue-400 text-sm font-medium">Gaziantep&apos;e Uzaktan Hizmet</span>
          </div>
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto mb-4 leading-relaxed">
            Gaziantep&apos;in tekstil/halı ihracatçılarına ve gıda üreticilerine özel SEO, Google Ads, web tasarım ve otomasyon — B2B ve ihracat satış huninize uygun kurgu.
          </p>
          <p className="text-zinc-500 text-sm mb-10">
            Şahinbey · Şehitkamil · Nizip · İslahiye · Oğuzeli · Nurdağı
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Gaziantep İşletmenizi Büyütecek Kanallar
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto">
              İhracat ağırlıklı Gaziantep pazarında B2B satış döngüsü uzun — doğru kanal kombinasyonu bu süreci kısaltır.
            </p>
          </div>
      ...
      <section className="py-16 px-6 bg-[#080D18]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-white mb-3">Gaziantep&apos;te Hizmet Verdiğimiz Sektörler</h2>
          <p className="text-zinc-500 text-sm mb-8">İhracat ve gıda üretiminin operasyonel diliyle konuşuyoruz, jenerik pazarlama kalıplarıyla değil.</p>
      ...
      <section className="py-20 px-6 bg-[#080D18]">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Gaziantep&apos;te Dijital Büyümeye Başlayın
          </h2>
