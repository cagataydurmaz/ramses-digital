...
const faqs = [
  ...
  { q: 'İstanbul\'da web sitesi fiyatları ne kadar?', a: 'Başlangıç paketleri 15.000 TL\'den, kurumsal 25.000 TL\'den, e-ticaret 40.000 TL\'den başlıyor. Domain ve hosting ayrıdır (yıllık ~1.000-2.500 TL). İstanbul\'daki büyük ajanslara göre daha esnek ve şeffaf fiyatlandırıyoruz — ücretsiz danışmanlıkta net fiyat alırsınız.' },
